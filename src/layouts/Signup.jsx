...
const Signup = () => {
    ...
    const { registerman, signwithg } = use(Contextapi)
    ...
    const handlepassword = (e) => {
        ...
        if(!regEx.test(e.target.value)){
            setmsg('6/6+ chars, upper & lower case required in password')
        }
        else{
            setmsg('')
        }
    ...
    return (
        <div className="my-6">
            <p className="text-4xl my-5 text-center font-black">Create a free account</p>
                ...
                <div className="card-body w-90">
                    <fieldset className="fieldset">
                        <form onSubmit={handlemanulregister} action="">
                            ...
                            <input required type="text" name='name' className="input placeholder-gray-400" placeholder="Name" />
                            <label className="label">Photo URL</label>
                            <input required type="url" name='photo' className="input placeholder-gray-400" placeholder="Photo URL" />
                            <label className="label">Email</label>
                            <input required type="email" name='email' className="input placeholder-gray-400" placeholder="Email" />
                            ...
                            <p className='text-red-500 text-[14px]'>{msg}</p>
                            <button className="btn bg-black text-white w-full mt-4">Register</button>
                        </form>
